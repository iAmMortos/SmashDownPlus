...
class SmashDownUI (ui.View):
	...
	def get_player_score_status(self, player):
		ps = self.sd.get_player_wins_map()[player]
	...
	def update_display(self):
		...
		self.adv1.text = self.get_player_score_status(self.p1_name)
		self.adv2.text = self.get_player_score_status(self.p2_name)
